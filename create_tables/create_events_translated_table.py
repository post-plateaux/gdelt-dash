...
create_table_query = f"CREATE TABLE events_translated ({columns});"
...
try:
    ...
    cursor.execute("DROP TABLE IF EXISTS events_translated;")
    print("Dropped table events_translated if it existed.")

    # Execute the table creation query
    cursor.execute(create_table_query)
    connection.commit()

    print("Table 'events_translated' created successfully.")
